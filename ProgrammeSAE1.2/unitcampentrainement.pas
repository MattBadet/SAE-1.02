...
begin
  ...
  begin
    ...
    begin
      deplacerCurseurXY(60,5);write('Le maître d''arme vous dit :');

      deplacerCurseurXY(30,7);write('Tu n''as pas encore le niveau pour apprendre une nouvelle compétence. Tu devrais revenir');
      deplacerCurseurXY(30,8);write('ici plus tard avant de te blesser.');
      deplacerCurseurXY(30,10);write('En attendant, va donc combattre de nouveaux monstres pour te muscler un peu');
    end;
